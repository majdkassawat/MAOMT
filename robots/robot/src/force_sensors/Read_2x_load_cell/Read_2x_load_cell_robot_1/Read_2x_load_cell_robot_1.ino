...
HX711_ADC LoadCell_1(7,8); //  Robot1: 3,2    -   Robot2: 7,8
HX711_ADC LoadCell_2(9,10); //  Robot1: 5,4    -   Robot2: 9,10
...
void setup() {
  ...
  calValue_1 = 1149; // Robot1 right: 1160, Robot2 right: 1149
  calValue_2 = 1137; // Robot1 left: 1093, Robot2 left: 1137
